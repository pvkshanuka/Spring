...
import lk.e_channelling.patient_service.repository.AppointmentRepository;
...
public class AppointmentServiceImpl implements AppointmentService {
    ...
    public ResponseDto save(Appointment appointment) {
        ...
        if (findByPatientAndChannellingId(appointment).isEmpty()) {
    ...
    @Override
    public List<Appointment> findByPatientAndChannellingId(Appointment appointment) {
        return appointmentRepository.findByPatientAndChannelling(appointment.getPatient(),appointment.getChannelling());
    }
}
